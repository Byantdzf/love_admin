<template>
    <div class="compose">
        <Dropdown>
            <Input  placeholder="Enter your mcircle" readonly="readonly" :value="InputValue" style="width: 300px"></Input>
            <DropdownMenu slot="list">
                ...
                <div style="min-width: 250px; height: 280px;overflow-y: scroll;position: relative">
                    <p v-for="item,index in list" :key="index" @click="gainValue(item)"  id="drop-p">{{item.name}}</p>
                </div>
